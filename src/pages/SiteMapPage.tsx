...
const CIDADES = [
  {
    ...
    bairros: [
      "Centro", "Dom Pedro I", "Dom Pedro II", "Cachoeira", "Inácia de Carvalho", "Jardim Encantado", 
      "Parque Jardim Encantado", "Belo Vale", "Campinho", "Chácaras Reunidas", "Nova Granja", 
      "Morada da Serra", "Vila Ical", "Vila Maria de Lourdes", "Vila Palmeiras", "Vila José Antônio", 
      "Vila Militar", "Parque Horizonte", "Serra Dourada", "Palmital", "Vale da Mata", 
      "Chácaras São Geraldo", "Cristina", "Industrial", "Lagoa", "Novo Horizonte", "Jardim Beira Rio", 
      "Parque Primavera", "Residencial Cachoeira", "Vila Rica", "Santa Fé", "Parque Real", 
      "Recanto da Lagoa", "Distrito Industrial", "Parque Verde", "São Benedito"
    ],
  },
  {
    nome: "Vespasiano",
    slug: "vespasiano",
    bairros: [
      "Centro", "Caieiras", "Célvia", "Gávea", "Jardim da Glória", "Jardim Itaú", "Jardim Alterosa", 
      "Morro Alto", "Morro Alto II", "Nova Pampulha", "Parque Jardim Itaú", "Parque Norte", 
      "Santa Clara", "Santa Cruz", "Santo Antônio", "Suely", "Vale Formoso", "Vila Esportiva", 
      "Vila Ipê", "Vila Verde", "Bernardo de Souza", "Nazia", "Residencial Park I", 
      "Residencial Park II", "Imperial", "Serra Azul", "Serra Dourada", "Jequitibá", 
      "Novo Horizonte", "Celvia II", "Conjunto Habitacional Vespasiano", "Jardim Encantado", 
      "Moradas da Lagoa", "Santa Maria", "Serra Verde", "Parque Serra Verde", "Bonsucesso", "Angicos"
    ],
  },
];
...
export default function SiteMapPage({ onBack, onStartBooking, onNavigate }: SiteMapPageProps) {
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {c.bairros.map((b) => {
                    ...
                    const citySlug = c.slug.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s+/g, "-");
                    return (
                      <button
                        key={b}
